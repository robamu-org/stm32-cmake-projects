...
void MX_USART3_UART_Init(uint32_t baudRate) {
  ...
  // HUART_3.Init.FIFOMode = UART_FIFOMODE_DISABLE;
  // HUART_3.Init.TXFIFOThreshold = UART_TXFIFO_THRESHOLD_1_8;
  // HUART_3.Init.RXFIFOThreshold = UART_RXFIFO_THRESHOLD_1_8;
...
void Netif_Config(void) {
  ...
  struct netif* netif_valid = netif_add(&gnetif, (ip4_addr_t*)&ipaddr, (ip4_addr_t*)&netmask,
